...
function Scanner(options) {
    ...
    self.render = function() {
        var str = "<html><head>"
            ...
            +"</head><body>";
        if(logo)
            str += "<div style='float:top;margin:auto;'><center><a href='http://vertcoin.org/' target='_blank'><img src=\""+logo+"\" height='60' /></a></center></div><br style='clear:both;'/>";
        ...
        _.each(list, function(info) {
            ...
            if (ip != '0.0.0.0') {
                ...
                str += "<div class='p2p-row "+(row++ & 1 ? "row-grey" : "")+"'><div class='p2p-ip'><a href='http://"+ip+":
		    71/static/' target='_blank'>"+ip+":11331</a></div><div class='p2p-fee'>"+fee+"%</div><div class='p2p-uptime'>"+uptime+" days</div>";
